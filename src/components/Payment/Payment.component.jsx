...
export default function PaymentModal({ isOpen, setIsOpen, price }) {
  ...
  const launchRazorPay = () => {
    let options = {
      key: "rzp_test_JBPngVxZEWBQY8",
      amount: price * 100,
      currency: "INR",
      name: "Cinemica",
      description: "Movie Purchase or Rental",
      image:
        "https://i.ibb.co/zPBYW3H/https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbiw1DykSbovhAMkTQhMjf-cHSUBOTVenAyg&usqp=CAU-bookmyshow-office-android-ticket-png.png",
      handler: () => {
        setIsOpen(false);
        alert("Payment Done");
      },
